...
from utils.chain_sim.network_provider.get_transaction_info import get_status_of_tx
from utils.chain_sim.validatorKey import ValidatorKey
...
def send_egld_to_address(egld_amount, erd_address):
    ...
    response = requests.post(f"{DEFAULT_PROXY}/simul,ator/set-state", data=json_structure)
